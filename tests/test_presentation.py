...
def test_present_sentence():
    ...
    p.present_sentence([{'р', 'П', 'ь', 'и', 'Н', 'т', 'л', 'с', 'х', 'е'}, {'т', 'л', 'а', 'й', 'к', 'е', 'в'},
     {'р', 'п', 'т', 'л', 'ч', 'а', 'о', 'и'}, {'ж', 'ь', 'з', 'т', 'а', 'к', 'у'}, {'i', 'й', 'к', 'п', 'о'},
     {'д', 'ш', 'т', 'а', 'i', 'к', 'у', 'и'}, {'О', 'д', 'н', 'т', 'ш', 'ч', 'а', 'о', 'е'},
     {'ь', 'н', 'т', 'а', 'i', 'г', 'с', 'о', 'в'}, {'р', 'л', 'а', 'г', 'х', 'о', 'и', 'в'},
     {'р', 'а', 'i', 'М', 'и', 'н'}, {'е', 'н'}, {'л', 'а', 'я', 'г', 'у', 'з'}, {'й'}, {'е', 'н'},
     {'л', 'а', 'i', 'с', 'в', 'п', 'з'}, {'й'}, {'е', 'н'}, {'з', 'н', 'т', 'л', 'а', 'ц', 'ю', 'в'}, {'г', 'о', 'й'},
     {'т', 'ь', 'а', 'i', 'в', 'н'}, {'в'}, {'К', 'i', 'и', 'є', 'в'}])
